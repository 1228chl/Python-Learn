...
from _05_d_bilstm_predict_fun import predict_fun
    ...
    <body>
        ...
        <div class="container">
            <div class="header">
                ...
                <div class="subtitle">// 基于bilstm的新闻文本智能分类系统</div>
            </div>
        ...
        <div class="status-bar">
            ...
            <div class="status-item">
                <span>MODEL: bilstm | STATUS: READY</span>
            </div>
            <div class="status-item">
                <span>PORT: 9091</span>
            </div>
...
if __name__ == '__main__':
    ...
    print("🚀 新闻文本分类系统启动中...")
    print("=" * 50)
    print("📍 访问地址: http://127.0.0.1:9096")
    print("=" * 50)
    app.run(debug=True, host='0.0.0.0', port=9096)
