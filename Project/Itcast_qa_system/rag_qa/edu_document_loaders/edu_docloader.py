...
from Project.Itcast_qa_system.rag_qa.edu_document_loaders.edu_ocr import get_ocr
# 导入必要的模块
...
if __name__ == '__main__':
    docx_loader = OCRDOCLoader(filepath='/Users/chan/projects/Itcast_qa_system/rag_qa/data/samples/ocr_02.docx')
